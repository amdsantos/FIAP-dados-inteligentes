...
let extraiRoteiroCentro = roteirosA[2].split("<br>");
let roteiroCentro = extraiRoteiroCentro[1];
document.getElementById("extraiRoteiroCentro").innerHTML = roteiroCentro;

//Extrai e exibe o nome dos pontos turísticos localizados no bairro Downtowm da cidade de Las Vegas.
let extraiRoteiroDowntown = roteirosA[5].split("<br>");
let roteiroDowntown = extraiRoteiroDowntown[1];
document.getElementById("extraiRoteiroDowntown").innerHTML = roteiroDowntown;
